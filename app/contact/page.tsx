            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-20">
              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <a href="mailto:support@westerninnovationtech.com" className="text-lg md:text-xl hover:text-[#FFCC33] transition-colors">
                    support@westerninnovationtech.com
                  </a>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <a href="tel:+234678WESTERN" className="text-lg md:text-xl hover:text-[#FFCC33] transition-colors">
                    +234 678 WESTERN
                  </a>
                </div>
